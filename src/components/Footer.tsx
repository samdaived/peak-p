      ...
      <div className="container mx-auto px-4">
        ...
        <div className="mb-8 pb-8 border-b border-border">
          <div className="flex items-center gap-2 mb-4">
            ...
            <h3 className="text-sm font-semibold text-foreground">{t.footer.legalInfo}</h3>
          </div>
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4 text-xs text-muted-foreground">
            <div className="space-y-1">
              <p className="font-medium text-foreground">SARL à Associé Unique</p>
            ...
            <div className="space-y-1">
              <p>{t.footer.capital}: 100,000 MAD</p>
            </div>
            <div className="space-y-1">
              <p className="text-muted-foreground/80">Import & Distribution</p>
              <p className="text-muted-foreground/80">Compléments Alimentaires & Dispositifs Médicaux</p>
            </div>
          </div>
        </div>
