...
import { Check, Pill, Scale, Leaf } from 'lucide-react';
import productImage from '@/assets/neovit-product.png';
            ...
            <div className="grid md:grid-cols-2 gap-0">
              ...
              <div className="p-8 md:p-12 flex flex-col justify-center">
                <div className="space-y-6">
                  {/* Product Name */}
                  <div>
                    <p className="text-sm font-medium text-primary mb-2">{t.product.brand}</p>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div className="flex items-center gap-2 text-sm">
                      ...
                      <span className="text-muted-foreground">{t.product.dosage}</span>
                    </div>
                    <div className="flex items-center gap-2 text-sm">
                    ...
                    <div className="flex items-center gap-2 text-sm col-span-2">
                      ...
                      <span className="text-muted-foreground">{t.product.madeIn}</span>
                    </div>
                  </div>

                  {/* Benefits */}
                  <div>
                    <p className="font-semibold text-foreground mb-3">{t.product.benefits}</p>
                  ...
                  <div className="p-4 rounded-xl bg-accent/50 border border-border">
                    <p className="font-semibold text-foreground mb-2">{t.product.usage}</p>
                    <p className="text-sm text-muted-foreground">{t.product.usageText}</p>
                  </div>
                </div>
              </div>
            </div>
